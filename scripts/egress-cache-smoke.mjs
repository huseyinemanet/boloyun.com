...
try {
  ...
  console.log(JSON.stringify({ environment: `Node ${process.version}, Next standalone, synthetic local HTTP fixture; not production. Shared cache entries may already be warm.`, results }, null, 2));
} finally {
  app.kill("SIGTERM");
