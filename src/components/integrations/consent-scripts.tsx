...
export function ConsentScripts({ settings }: { settings: IntegrationSettings }) {
  ...
  return <>
    <AnalyticsRuntime allowed={canLoadOptionalScripts} googleAnalytics={Boolean(settings.googleAnalyticsId)} googleTagManager={Boolean(settings.googleTagManagerId)} />
