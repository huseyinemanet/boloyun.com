      ...
      <section className="rounded-md border border-border bg-card p-4">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">Favorilerini, yorumlarını ve son oynadığın oyunları buradan takip edebilirsin.</p>
            {settings.community.profilePhotoEnabled ? <ProfileAvatarUpload /> : null}
          </div>
        </div>
      </section>
